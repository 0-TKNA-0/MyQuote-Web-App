class ApplicationController < ActionController::Base
    ...
    # database is queried only once per request, even if current_user is called multiple times.
    def current_user
    ...
    # the setting of the session[:is_admin] value. If true, the user is an admin, otherwise they are a standard user.
    ...
    private
        ...
        # applied as a before_action in controllers where some or all of the resident methods require authentication to be executed.
        def require_login
            unless logged_in?
